...
def prims_mst(graph: Graph, start_node: str):
    """
    Prim's Algorithm – Greedy approach to find Minimum Spanning Tree.

    Strategy (Greedy):
        At every step, pick the CHEAPEST edge that connects a visited node
        to an unvisited node.  This local greedy choice always leads to a
        globally optimal MST.
